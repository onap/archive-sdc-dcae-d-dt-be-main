...
public class MappingRulesValidatorTest {
    ...
    private static final String TRANSLATION_ERROR_ENTRY_VARIABLE_TEXT = "entry phase name already exists";
    private static final String TRANSLATION_ERROR_PUBLISH_VARIABLE_TEXT = "publish phase name already exists";
    ...
    public void validateTranslationPhaseNamesTest() {
        ...
        assertEquals(TRANSLATION_ERROR_PUBLISH_VARIABLE_TEXT, exceptionPublishPhase.getVariables()[0]);
    }
